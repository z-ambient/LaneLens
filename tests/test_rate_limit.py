"""Tests for the spoof-resistant rate-limit key (app.main.client_ip).
...
def test_header_shorter_than_hops_falls_back_to_socket(monkeypatch):
    ...
    monkeypatch.setattr(main_module, "TRUSTED_PROXY_HOPS", 2)
...
def test_zero_hops_ignores_forwarded_header(monkeypatch):
    ...
    monkeypatch.setattr(main_module, "TRUSTED_PROXY_HOPS", 0)
